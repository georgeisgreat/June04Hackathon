      ...
      <div className="w-full max-w-md rounded-xl border border-[#30363d] bg-[#161b22] p-5 shadow-glow">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-[#8b949e]">Start a shared chat to collaborate in real time.</p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-4 rounded-lg border border-[#30363d] bg-[#0d1117] p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="font-medium text-white">Emily</div>
              <div className="text-xs text-[#8b949e]">emily@team.com</div>
            </div>
            <button
              type="button"
              aria-label="Add Emily"
        ...
        {inviteLink ? (
          <div className="mt-4 rounded-lg border border-[#30363d] bg-[#0d1117] p-3">
            <div className="text-xs font-medium uppercase tracking-[0.08em] text-[#6e7681]">Emily invite link</div>
